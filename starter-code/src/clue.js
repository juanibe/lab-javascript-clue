...
function pickMistery(){
  ...
  var misteryCharacter = randomSelector(cards[0])
  var misteryRoom = randomSelector(cards[1])
  var misteryWeapon = randomSelector(cards[2])
  var envelope = []
  envelope.push(misteryCharacter,misteryWeapon,misteryRoom);
  return envelope;
